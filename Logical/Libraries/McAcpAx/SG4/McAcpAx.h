...
typedef enum McACMVCFreqAdaptionEnum
{	mcACMVCFA_NOT_USE = 0,
	mcACMVCFA_USE = 1
} McACMVCFreqAdaptionEnum;

typedef enum McACMVCAmpAdaptionEnum
{	mcACMVCAA_NOT_USE = 0,
	mcACMVCAA_USE = 1
...
typedef struct McACMVCFreqAdaptionUseType
{	float ProportionalGain;
	float IntegrationTime;
	float ReferenceValue;
} McACMVCFreqAdaptionUseType;

typedef struct McACMVCFreqAdaptionType
{	enum McACMVCFreqAdaptionEnum Type;
	struct McACMVCFreqAdaptionUseType Used;
} McACMVCFreqAdaptionType;

typedef struct McACMVCAmpAdaptionUseType
{	float ProportionalGain;
	float IntegrationTime;
	float ReferenceValue;
} McACMVCAmpAdaptionUseType;

typedef struct McACMVCAmpAdaptionType
{	enum McACMVCAmpAdaptionEnum Type;
	struct McACMVCAmpAdaptionUseType Used;
} McACMVCAmpAdaptionType;
...
{	float ExcitationFrequency;
	...
	struct McACMVCFreqAdaptionType FrequencyAdaption;
	struct McACMVCAmpAdaptionType AmplitudeAdaption;
