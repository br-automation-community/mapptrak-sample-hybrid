TYPE
	...
	McACMVCFreqAdaptionUseType : STRUCT (*Type mcACMVCFA_USE settings*)
	...
	END_STRUCT;
	McACMVCFreqAdaptionType : STRUCT (*Usage of the frequency adaption*)
		Type : McACMVCFreqAdaptionEnum; (*Frequency adaption selector setting*)
		Used : McACMVCFreqAdaptionUseType; (*Type mcACMVCFA_USE settings*)
	END_STRUCT;
	McACMVCAmpAdaptionEnum :
	...
	McACMVCAmpAdaptionUseType : STRUCT (*Type mcACMVCAA_USE settings*)
	...
	END_STRUCT;
	McACMVCAmpAdaptionType : STRUCT (*Usage of the amplitude adaption*)
		Type : McACMVCAmpAdaptionEnum; (*Amplitude adaption selector setting*)
		Used : McACMVCAmpAdaptionUseType; (*Type mcACMVCAA_USE settings*)
	END_STRUCT;
	McACMVCCurCtrlEnum :
	...
	McACMVCType : STRUCT (*Type mcACM_VIB_CTRL settings*)
		...
		FrequencyAdaption : McACMVCFreqAdaptionType; (*Usage of the frequency adaption*)
		AmplitudeAdaption : McACMVCAmpAdaptionType; (*Usage of the amplitude adaption*)
